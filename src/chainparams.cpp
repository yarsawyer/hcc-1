...
{
    const char* pszTimestamp = "HealthCare Coin Created To Help India And The World To Fight Covid19";
    const CScript genesisOutputScript = CScript() << ParseHex("0452c210cf0e28d43158123b1ba4d3842122836c1d9b45681ccfcbfb6c607231a74e3412ae631ef799158b9c1d776b88da27889ac934b9f19b2b5349e30f7b845d") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 1734; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        consensus.nMasternodePaymentsIncreaseBlock = 1735; // actual historical value
        ...
        //consensus.BIP34Hash = uint256S("0x0000048b5e99f6f2fe91b1432a6bdd29bad13fc241a0a70a38c3de78a7f60053");
        consensus.BIP34Hash = uint256S("0x000007758cc899f495608f84e039a9ff0293867d2d20906fd236a8bf5ea03950");
        consensus.BIP65Height = 2; // 00000000000076d8fcea02ec0963de4abfd01e771fec0863f960c2c64fe6f357
        consensus.BIP66Height = 2; // 00000000000b1fa2dfa312863570e13fae9ca7b5566cb27e55422620b469aefa
        consensus.DIP0001Height = 2;
        consensus.DIP0003Height = 2;
        consensus.DIP0003EnforcementHeight = 2;
        //consensus.DIP0003EnforcementHash = uint256S("0000048b5e99f6f2fe91b1432a6bdd29bad13fc241a0a70a38c3de78a7f60053");
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 1624453645; // July 1st, 2021
        ...
        genesis = CreateGenesisBlock(1625672461, 2171811, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0000002f1568bdf68617d63eee409514c6a405a44c6c7cf8a22d8d6e269b58af"));
        assert(genesis.hashMerkleRoot == uint256S("0x54c9b6dc77cc0bf62fe527ace941e98d0e8a83eb5402ed1a417ab9137bbd74ba"));
        ...
        // Dash script addresses start with '8'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,18);
        // Dash private keys start with '8' or 'H'
        ...
        vSporkAddresses = {"HPPYb8TPcVH6QLM4SCxyxcptn7LdRisM5a"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1625672462, 135067, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000006cb5087568eb3d55994f686806c0a74e52cb6cea8f85cfd6fe9c04061a4"));
        assert(genesis.hashMerkleRoot == uint256S("0x54c9b6dc77cc0bf62fe527ace941e98d0e8a83eb5402ed1a417ab9137bbd74ba"));
        ...
        chainTxData = ChainTxData{
            0, // * UNIX timestamp of last known number of transactions (Block 477483)
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        //genesis = CreateGenesisBlock(1624453646, 3858791, 0x207fffff, 1, 50 * COIN);
        genesis = CreateGenesisBlock(1625672464, 381948, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000d769c70937932af03d930e12495f202727075395bfd638795aea6019214"));
        assert(genesis.hashMerkleRoot == uint256S("0x54c9b6dc77cc0bf62fe527ace941e98d0e8a83eb5402ed1a417ab9137bbd74ba"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1625672463, 531641, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000062cabf8b73b976881aee06b21ee28d1ec6a34a461ac396ec8a3840ecc85"));
        assert(genesis.hashMerkleRoot == uint256S("0x54c9b6dc77cc0bf62fe527ace941e98d0e8a83eb5402ed1a417ab9137bbd74ba"));
